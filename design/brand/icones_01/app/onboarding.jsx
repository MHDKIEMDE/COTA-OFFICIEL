    ...
    <div style={{ background: oBG, color: oINK, height: '100%', position: 'relative', fontFamily: oFONT.ui }}>
      ...
      <div style={{ position: 'absolute', inset: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ whiteSpace: 'nowrap', fontFamily: oFONT.mono, fontSize: 10, color: oDIM, letterSpacing: '0.12em' }}>
            {'  '}PSG–OM @1.65{'   ·   '}LIV–ARS +2.5 @1.78{'   ·   '}RMA–BAY BTTS @1.55{'   ·   '}COUPON DU JOUR @4.55{'   ·   '}87% CONFIANCE{'   ·   '}PSG–OM @1.65{'   ·   '}
          </div>
        </div>
      </div>
      ...
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '0 24px 50px', display: 'flex', flexDirection: 'column', gap: 22 }}>
        ...
        <div style={{ fontSize: 14, color: oINK2, lineHeight: 1.45 }}>
          9 critères, 1 score de confiance, 1 coupon par jour. Pas de baratin, pas d'émotion : que de la donnée.
        </div>

        {/* stat strip */}
        <div style={{ display: 'flex', gap: 12 }}>
          {[['9', 'critères IA'], ['1', 'coupon / jour'], ['+18%', 'ROI saison']].map(([n, l]) => (
...
function OnboardCriteria() {
  const C = [
    ...
    { n: '06', l: 'Cotes marché',         v: 'consensus' },
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: oDIM, marginTop: 1 }}>Ton coupon est prêt</div>
              </div>
            </div>
            <div style={{ fontSize: 14, fontWeight: 600, lineHeight: 1.4 }}>
              3 picks combinés · confiance <span style={{ color: oACCENT, fontFamily: oFONT.mono }}>87%</span>
            </div>
            <div style={{ marginTop: 4, fontSize: 12, color: oDIM2 }}>
              Cote <span style={{ fontFamily: oFONT.mono, color: oINK, fontWeight: 700 }}>@4.55</span> · PSG · LIV · RMA
            </div>
          </div>
        </div>
      </div>
