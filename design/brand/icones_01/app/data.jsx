...
const MATCHES = [
  {
    ...
    criteria: [
      ...
      { name: 'Cotes du marché',    value: '1.65 / 4.20 / 4.50', signal: 'neutral' },
  ...
  },
  {
    ...
    pick: { type: 'Plus de 2.5 buts', odds: 1.78 },
    score: '2-2',
    confidence: 76,
  ...
  },
  {
    ...
    pick: { type: 'Moins de 2.5 buts', odds: 1.92 },
    score: '1-0',
    confidence: 62,
...
// The 3 picks that make today's combined coupon.
const COUPON = {
  date: 'Mar 18 mai',
  picks: [
    { matchId: 'psg-om', label: 'PSG - OM',  type: 'Victoire PSG',  odds: 1.65, confidence: 87 },
    { matchId: 'liv-ars', label: 'LIV - ARS', type: '+2.5 buts',     odds: 1.78, confidence: 76 },
    { matchId: 'rma-bay', label: 'RMA - BAY', type: 'BTTS Oui',       odds: 1.55, confidence: 91 },
  ],
