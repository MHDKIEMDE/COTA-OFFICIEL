    ...
    <div style={{ width: 720, padding: 32, background: cBG2, color: cINK, fontFamily: cFONT.ui }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
        ...
        <div>
          ...
          <div style={{ fontFamily: cFONT.mono, fontSize: 11, color: cDIM, letterSpacing: '0.18em', marginTop: 10 }}>APP DE PRONOSTICS FOOT · IA</div>
        </div>
      </div>
...
function App() {
  return (
    <DesignCanvas defaultLayout="grid">
      ...
      <DCSection id="onboarding" title="01 · Onboarding" subtitle="3 écrans : hero cinématique, les 9 critères, le rituel du coupon.">
      ...
      <DCSection id="app" title="02 · App mobile" subtitle="Home avec hero coupon, détail match avec 9 critères, coupon combiné, notifs, profil.">
        ...
        <DCArtboard id="coupon"label="Coupon du jour"    width={402} height={874}><Phone><ScreenCoupon /></Phone></DCArtboard>
      ...
      <DCSection id="anim" title="03 · Animations" subtitle="Splash analyse, révélation de confiance, validation du coupon. En boucle dans leurs cadres.">
        ...
        <DCArtboard id="anim-3" label="Coupon validé"           width={600} height={500}><AnimBox><AnimCouponValid /></AnimBox></DCArtboard>
      </DCSection>
